...
interface Idea {
    id: string;
    text: string;
    title?: string; // Title is often optional/null in the database
    upvotes: number;
    created_at: string; // Received as a string from the API
}
...
// Component signature updated to use IdeaCardProps
export default function IdeaCard({ idea, refetchIdeas }: IdeaCardProps) {
	...
	const cardStyle = useMemo(() => {
		...
		// Safely pull the full Tailwind class names from the object
